...
<ul id="navlist">
	...
	<li><a href="#"><?php $d = mysql_query("SELECT * FROM web_data WHERE m_id=8");$data = mysql_fetch_array($d);echo ($data['name']);?></a></li>
	...
	<li id="active"><a href="#" id="current"><?php $d = mysql_query("SELECT * FROM web_data WHERE m_id=12");$data = mysql_fetch_array($d);echo ($data['name']);?></a> 
		<ul id="subnavlist">
			<li id="subactive"><a href="#" id="subcurrent"><?php $d = mysql_query("SELECT * FROM web_data WHERE m_id=13");$data = mysql_fetch_array($d);echo ($data['name']);?></a></li>
...
<div id="footer_content">
	...
	<div align="center" style="font-family:Segoe Print"><a href="#" style="text-decoration:none" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href),'width=626,height=436'); return false;"><?php $d = mysql_query("SELECT * FROM web_data WHERE m_id=24");$data = mysql_fetch_array($d);echo ($data['name']);?></a></div>
	</div>
